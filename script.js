const quotes = [
	...
	"Never let the fear of striking out keep you from playing the game. - Babe RuthBabe Ruth",
...
document.getElementById('generate-button').addEventListener('click', displayRandomQuote);
